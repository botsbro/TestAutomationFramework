...
public class SuiteListener implements ITestListener, IAnnotationTransformer {
    ...
    public void onTestFailure(ITestResult iTestResult){
        ...
        String fileName = System.getProperty("user.dir") + File.separator + "screenshots" + File.separator + "TestFailScreenshot";

        /*File f = ((TakesScreenshot) CommonTest.driver).getScreenshotAs(OutputType.FILE);
